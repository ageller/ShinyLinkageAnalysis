...
ShinyLinkageAnalysis <- function(){
	...
	ui <- fluidPage(
		...
		tags$div(style="font-size:14px; padding-left:18px; margin-bottom:20px",
			tags$p("Credit: Aaron M. Geller - Northwestern University IT Research Computing Services (RCS)"),
	...
	server <- function(input, output, session) {
		...
		shinyalert(
			...
			<p style = 'font-size:3vh; margin-top:2vh; font-weight:400'>I agree to not upload any identifiable information, code, or key per HIPAA and PII standard and to abide by any additional regulations of my host country and institution.</p>
